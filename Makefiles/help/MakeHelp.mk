...
help:
	@python Makefiles/help/print_makefile_help.py $(MAKEFILE_LIST)
...
help-with-private-rules:
	@python Makefiles/help/print_makefile_help.py --show-private-rules $(MAKEFILE_LIST)

%-help help-%:
	@python Makefiles/help/print_makefile_help.py --rule "$*" $(MAKEFILE_LIST)